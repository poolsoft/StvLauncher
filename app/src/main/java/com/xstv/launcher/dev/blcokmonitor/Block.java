...
public final class Block {
    ...
    public static Block newInstance() {
        ...
        block.freeMemory = String.valueOf(PerformanceUtils.getFreeMemory() / 1024) +" MB";
        block.totalMemory = String.valueOf(PerformanceUtils.getTotalMemory() / 1024) + " MB";
        return block;
    }
    ...
    public Block setMainThreadTimeCost(long realTimeStart, long realTimeEnd, long threadTimeStart, long threadTimeEnd) {
        ...
        SimpleDateFormat TIME_FORMATTER = new SimpleDateFormat("MM-dd HH:mm:ss.SSS");
    ...
    public Block flushString() {
        ...
        cpuSb.append(KEY_CPU_RATE).append(KV).append("\n").append(cpuRateInfo).append(separator);
