...
/**
 * Queue of things to run on a looper thread. Items posted with {@link #post} will not be actually enqued on the handler until after the last one has run, to keep from starving the thread. This class
 * is fifo.
 */
public class DeferredHandler {
    private final LinkedList<Pair<Runnable, Integer>> mQueue = new LinkedList<Pair<Runnable, Integer>>();
    ...
    /** Schedule runnable to run after everything that'mFragmentContentView on the queue right now. */
