...
package com.xstv.desktop.leanback.ui;
...
import com.xstv.desktop.leanback.R;
import com.xstv.desktop.leanback.data.FetchVideoService;
import com.xstv.desktop.leanback.data.VideoContract;
import com.xstv.desktop.leanback.model.Video;
import com.xstv.desktop.leanback.model.VideoCursorMapper;
import com.xstv.desktop.leanback.presenter.CardPresenter;
import com.xstv.desktop.leanback.presenter.IconHeaderItemPresenter;
import com.xstv.desktop.leanback.recommendation.UpdateRecommendationsService;
        ...
        if (data != null && data.moveToFirst()) {
            ...
            if (loaderId == CATEGORY_LOADER) {
               ...
               /* HeaderItem gridHeader = new HeaderItem(getString(R.string.more_samples));
                ...
                /*HeaderItem testHeader = new HeaderItem("新视家");
                GridItemPresenter testPresenter = new GridItemPresenter(this);
                ArrayObjectAdapter testRowAdapter = new ArrayObjectAdapter(testPresenter);
                testRowAdapter.add("1");
                testRowAdapter.add("2");
                testRowAdapter.add("3");
                testRowAdapter.add("4");
                testRowAdapter.add("5");
                testRowAdapter.add("6");
                testRowAdapter.add("7");
                testRowAdapter.add("8");
                ListRow testRow = new ListRow(testHeader, testRowAdapter);
                mCategoryRowAdapter.add(testRow);*/

                /*// Create a test page row
                HeaderItem pageRowHeader = new HeaderItem("新视家整页");
                PageRow pageRow = new PageRow(pageRowHeader);
