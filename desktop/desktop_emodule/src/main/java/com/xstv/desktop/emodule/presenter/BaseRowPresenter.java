...
import com.xstv.desktop.emodule.view.RowContainerView;

/**
 * An abstract {@link Presenter} that renders a {@link Row}.
 *
 * <h3>Customize UI widgets</h3>
 * When a subclass of BaseRowPresenter adds UI widgets, it should subclass
 ...
 * that may exist in the parent fragment. BaseRowPresenter contains an optional and
 ...
 * BaseRowPresenter receives calls from its parent (typically a Fragment) when:
 * <ul>
 * <li>
 ...
 * Subclasses of BaseRowPresenter may override {@link #onRowViewSelected(ViewHolder, boolean)}.
 * </li>
 * <li>
 ...
 * Subclasses of BaseRowPresenter may override {@link #onRowViewExpanded(ViewHolder, boolean)}.
 * </li>
 * </ul>
 *
 ...
 *
 * <h3>User events</h3>
 * BaseRowPresenter provides {@link OnItemViewSelectedListener} and {@link OnItemViewClickedListener}.
 ...
 * 0 and 1.  By default, the BaseRowPresenter draws a dim overlay on top of the row
...
public abstract class BaseRowPresenter extends Presenter {
    ...
    public static class ContainerViewHolder extends Presenter.ViewHolder {
         ...
         */
        final public ViewHolder mRowViewHolder;
        ...
        public ContainerViewHolder(RowContainerView containerView, ViewHolder rowViewHolder) {
            ...
            containerView.setTag(ItemBasePresenter.VIEW_HOLD_ID,this);
        }
    }
    ...
    public interface OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
                                  ViewHolder rowViewHolder, Object row);
    }
    ...
    public static class ViewHolder extends Presenter.ViewHolder {
        ...
        float mSelectLevel = 1.0f; // initially unselected
         ...
         * when {@link BaseRowPresenter#getSyncActivatePolicy()} is
         * {@link BaseRowPresenter#SYNC_ACTIVATED_CUSTOM}; otherwise the value will
         ...
         * application does not need to call this method,  {@link android.support.v17.leanback.widget.ListRowPresenter} automatically
         * calls this method when a child is attached to list row.   However if
         * application writes its own custom BaseRowPresenter, it should call this method
        ...
        /**
         * Sets the listener for staggered_item or row selection.  BaseRowPresenter fires row selection
         * event with null staggered_item.  A subclass of BaseRowPresenter e.g. {@link android.support.v17.leanback.widget.ListRowPresenter} may
         * fire a selection event with selected staggered_item.
         */
        ...
        /**
         * Returns the listener for staggered_item or row selection.
         */
        ...
        /**
         * Sets the listener for staggered_item click event.  BaseRowPresenter does nothing but subclass of
         * BaseRowPresenter may fire staggered_item click event if it has the concept of staggered_item.
        ...
        /**
         * Returns the listener for staggered_item click event.
         */
    ...
    protected RowHeaderPresenter mHeaderPresenter = new RowHeaderPresenter();
    ...
    /**
     * Constructs a BaseRowPresenter.
     */
    public BaseRowPresenter() {
        mHeaderPresenter.setNullItemVisibilityGone(true);
    }

    public void setRowHeaderPresenter(RowHeaderPresenter presenter){
        mHeaderPresenter = presenter;
    }
    ...
    public final Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        if (needsRowContainerView()) {
            ...
            if (mHeaderPresenter != null && vh.view instanceof ViewGroup) {
    ...
    /**
     * Returns the {@link ViewHolder} from the given BaseRowPresenter
     * ViewHolder.
     */
     ...
     * selected status and expanded status of the BaseRowPresenter ViewHolder.
     */
     ...
     * The default behavior is to signal row selected events with a null staggered_item parameter.
     * A Subclass of BaseRowPresenter having child items should override this method and dispatch
     * events with staggered_item information.
     */
    ...
    /**
     * Returns true if this BaseRowPresenter is using the default dimming effect.
    ...
    protected void onBindRowViewHolder(ViewHolder vh, Object item) {
        if(item instanceof Row) {
            ...
            if (vh.mHeaderViewHolder != null) {
                ...
                mHeaderPresenter.setSelectLevel(vh.mHeaderViewHolder, 1);
            }
    ...
    public void setSelectPosition(ViewHolder vh, int position){
